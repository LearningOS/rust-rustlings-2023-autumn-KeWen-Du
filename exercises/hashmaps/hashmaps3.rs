...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        // team_1.
        let g = scores.entry(team_1_name.to_string()).or_insert(Team{goals_scored:0,goals_conceded:0});
        (*g).goals_scored = (*g).goals_scored + team_1_score;
        (*g).goals_conceded = (*g).goals_conceded + team_2_score;
        let f = scores.entry(team_2_name.to_string()).or_insert(Team{goals_scored:0,goals_conceded:0});
